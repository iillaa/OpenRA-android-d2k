...
* **Modern Tablet UI Scaling (1.8× HUD)**: Specially optimized for large, high-density displays (such as 12.7" 2560×1600 tablets). The sidebar, production palette, and radar are scaled up by 1.8× for comfortable touch navigation while preserving 100% sharp native resolution on the battlefield.
* **Hybrid Dual-Input Control System**:
  ...
  * **Bluetooth / Hardware Mouse**: True PC-style desktop gameplay with native Left-Click box selection, Right-Click move/attack commands, Scroll Wheel zoom, and 25px screen-edge scrolling.
...
* **Built-in Diagnostic & Developer Tools**:
  * Floating draggable **DevConsole** bubble (`🐛`) with full-screen color-coded logs (Information, Warnings, Errors).
